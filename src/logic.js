    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, exports.db.collection('questions').insertOne(__assign({}, question, { id: questionId, answers: [], likes: [] }))];
            case 2:
                _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, exports.db.collection('answers').insertOne(__assign({}, answer, { id: answerId, questionId: questionId, likes: [] }))];
            case 2:
                _a.sent();
