...
describe('answer question ', function () {
    ...
    test('get answer returns same answer with question id', function () { return __awaiter(_this, void 0, void 0, function () {
        var answer;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    answer = _a.sent();
                    expect(answer).toMatchObject(__assign({}, newAnswer, { questionId: questionId }));
                    return [2 /*return*/];
            }
        });
    }); });
